...
export interface CSVImporterReturn {
	state: ImporterState;
	step: import("solid-js").Accessor<ImporterStep>;
	isLoading: import("solid-js").Accessor<boolean>;
	isComplete: import("solid-js").Accessor<boolean>;
	hasErrors: import("solid-js").Accessor<boolean>;
	canGoBack: import("solid-js").Accessor<boolean>;
	canGoForward: import("solid-js").Accessor<boolean>;
